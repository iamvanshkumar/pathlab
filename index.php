...
<head>
    ...
    <title>KUMAR PATHOLOGY LAB | HOME</title>
    ...
    <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-gray-200 dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                ...
                <span
                    class="self-center text-xl font-bold whitespace-nowrap text-blue-500 dark:text-white uppercase">Kumar
                    Pathology Clinic</span>
            </a>
            <div class="flex md:order-2">
                <button type="button"
                    class="hidden md:block text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 uppercase">
                    <i class='bx bx-calendar-heart mr-2'></i>BOOK APPOINTEMENT</button>
    ...
    <main class="mt-16">
        <section class="max-w-screen-xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 ">
                ...
                <div class="grid content-center m-auto justify-center slideIN">
                    <h2 class="md:text-4xl uppercase font-semibold">Welcome To</h2>
                    <h1 class="md:text-5xl font-bold text-blue-500 uppercase">
                        KUMAR PATHOLOGY CLINIC</h1>
                    <span class="text-md text-gray-700 justify-self-end ">The best you can get !!</span>
                    <div>BOOK&nbsp;
                        YOUR TEST APPOINTEMENT NOW</a></div>
                </div>

                <div class="slideOut grid justify-center m-auto content-center">
                    <img class="mt-12 py-4 justify-center relative move" src="./assets/img/hero.png" alt="">
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="bg-blue-500 shadow-lg h-12">
                sad
            </div>
